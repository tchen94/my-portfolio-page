...
export default function ContactPage() {
  ...
  return (
    <>
      <h1 className="animate-fadeintop text-[50px] flex justify-center mt-[100px]">Contact</h1>
      <div className="w-full max-w-sm mx-auto my-5 border border-gray-100 rounded-md p-7 animate-fadeintop">
        {!isSubmitSuccessful && (
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <button
              type="submit"
              className="w-full py-4 text-white transition-colors bg-[--foreground] rounded-md hover:brightness-110 focus:outline-none focus:ring-offset-2 focus:ring focus:ring-indigo-200 px-7 umami--click--contact-submit">
              {isSubmitting ? (
                <svg
        ...
        {isSubmitSuccessful && isSuccess && (
          <>
            <div className="flex flex-col items-center justify-center text-center text-white rounded-md">
              ...
              <button
                className="mt-6 text-[--foreground] focus:outline-none"
                onClick={() => reset()}>
                Go back
              </button>
            </div>
